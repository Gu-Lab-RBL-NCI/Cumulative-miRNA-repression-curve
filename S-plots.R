...
IDH1 <- read.csv("IDH1_cgc_case_explorer_selected_data.csv", header = TRUE)
...
write.table(alternativemachedtargets, "alternativemachedtargets.txt", sep="\t", append = FALSE, row.names = F)
...
#two target site
alternative2 <- alternativemachedtargets[ which(alternativemachedtargets$total>=2),]
...
#alternativemore3 <- alternativemachedtargets[ which(alternativemachedtargets$total>=3),]
...
#alt8mer <- alternative1[ which(alternative1$X8mer==1),]
...
#alt7merm8 <- alternative1[ which(alternative1$X7mer.m8==1),]
...
#alt7mera1 <- alternative1[ which(alternative1$X7mer.1A==1),]
